...
command! SfdxSoqlExecuteMarkdownBlock call sfdx#main('data', 'execute_markdown_soql_block')
...
command! SfdxDeployForce call sfdx#main('source', 'deploy_force')
command! SfdxRetrieveForce call sfdx#main('source', 'retrieve_force')
